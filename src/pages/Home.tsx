      ...
      try {
        ...
        const response = await ai.models.generateContent({
          ...
          contents: {
            parts: [
              {
                text: 'A photorealistic, modern, wide-angle shot of a premium home appliances store showroom interior. Featuring sleek air conditioners on the wall, a modern refrigerator, a washing machine, and a microwave. Professional lighting, red and white color accents, clean and minimalist design, high quality.',
              },
            ],
          },
          config: {
